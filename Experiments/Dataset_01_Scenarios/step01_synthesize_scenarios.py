...
def generate_scenario(list_scope, list_severity, list_category, list_domain, list_entropy):
...
if __name__ == "__main__":
    ...
    for i in range(2000):
        ...
        scenario = generate_scenario(list_scope, list_severity, list_category, list_domain, list_entropy)
        messages = [
